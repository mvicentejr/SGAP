...
<div class="pull-right">
    <h2 class="text-center">Venda - Editar Produtos</h2>
</div>
<div class="jumbotron">
    <div class="col-lg-6 margin-tb">
        <form class="form" action="{{ route('itensvendas.update', $item->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="field">
                <strong>Venda: </strong> {{$item->venda->id}}
                <input type="hidden" class="input" name="venda" value="{{$item->venda->id}}">
            </div>
            <div class="field">
            ...
            <div class="field">
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <div class="control">
                            <input type="number" class="input" name="quantidade" value="{{$item->quantidade}}" id="quantidade" onkeyup="calculaTotal()">
                        </div>
                    </div>
                </div>
            </div>
            <div class="field">
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <div class="control">
                            <input type="text" class="input" name="itemvalor" value="{{$item->itemvalor}}" id="itemvalor" onkeyup="calculaTotal()">
                        </div>
                    </div>
                </div>
            </div>
            <div class="field">
                <div class="form-row">
                    <div class="col-4">
                        ...
                        <div class="control">
                            <input type="text" class="input" name="itemtotal" value="{{$item->itemtotal}}" id="itemtotal">
                        </div>
                    </div>
                </div>
            </div>
